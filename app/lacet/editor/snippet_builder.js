(function () {
            ...
            bootbox.dialog({
                ...
                buttons: {
                    success: {
                        ...
                        callback: function () {
                            self.saveCustomSnippet(function(){
                                deferred.resolve();
                            });
                        }
                    }
    ...
    SnippetBuilder.prototype.removeCustomSnippet = function (id,cb) {
        var that = this;
    ...
    SnippetBuilder.prototype.serializeSnippet = function( ){
        ...
        if(self.javascriptEditor.getValue()){
            data['javascript'] = self.javascriptEditor.getValue();
        }
    ...
    SnippetBuilder.prototype.loadSnippetJson = function(snippetJson){
        try{
            ...
            if(snippet){
                ...
                snippet.setJavascript(snippetJson.javascript);
    ...
    SnippetBuilder.prototype.saveCustomSnippet = function (cb) {
        var that = this;
    ...
    SnippetBuilder.prototype.initEditors = function(id){
        ...
        if(id){
            window.custom_snippets.getById(id,function(data){
                ...
                if(data.javascript){javascript =data.javascript;}
                ...
                self.javascriptEditor = self.configureEditor("javascriptEditor",javascript,'javascript');
            });
        }else{
            self.schemaEditor = self.configureEditor("schema",schema,'json');
            self.htmlEditor = self.configureEditor("template",template,"html");
