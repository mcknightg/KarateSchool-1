(function () {
    ...
    LacetInspector.prototype.buildContainerDropList = function(){
        var containers =   this.getPage().listContainers();
        console.log(containers);
        var containerItems = [];
        containerItems.push('<li><a>None</a></li>');
        $.each(containers,function(idx,form){
            try{
                var name = form.properties.name;
                if(name && name !== 'untitled'){
                    containerItems.push('<li><a>' + name + '</a></li>');
                }
            }catch(e){
                console.log(e);
            }
    ...
    LacetInspector.prototype.saveEditors = function () {
        ...
        window.lacetEditor.selectedcontrol.setJavascript( window.javascriptEditor.getValue());
    ...
    LacetInspector.prototype.renderEditors = function () {
        ...
        window.javascriptEditor = this.configureEditor("javascriptEditor",window.lacetEditor.selectedcontrol.javascript ,"javascript");
