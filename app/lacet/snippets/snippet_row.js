...
//register with the snippet manager
window.snippetManager.registerSnippet({kind:'bootstrap.row',klass:'SnippetRow',name:'1 Column Row',icon:'fa fa-edit',category:'Columns'});
window.snippetManager.registerSnippet({kind:'bootstrap.row',klass:'SnippetRow2Col',name:'2 Column Row',icon:'fa fa-edit',category:'Columns'});
window.snippetManager.registerSnippet({kind:'bootstrap.row',klass:'SnippetRow3Col',name:'3 Column Row',icon:'fa fa-edit',category:'Columns'});
window.snippetManager.registerSnippet({kind:'bootstrap.row',klass:'SnippetRow4Col',name:'4 Column Row',icon:'fa fa-edit',category:'Columns'});
