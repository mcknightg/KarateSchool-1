var SnippetTypes =  Class.extend({
    ...
    init:function(){
        ...
        this.add(BootstrapSnippet).add(BootstrapField).add(BluntText)
    ...
    add:function(snippet){
        if(!snippet.id){
            console.log('snippet must have a parameter named kind i.e {kind:"yourcompany.button"}');
        }
...
var BluntText={
  'id':'blunt.text',
    'type': "object",
    'properties':{
        'text':{ 'type': 'string','default':'<h2>What is Lorem Ipsum?</h2>'}
    }
};
...
var BootstrapImage={
    ...
    'type': "object",
    'properties':{
        'image':{'type': 'string','format':'imageChooser','default':'img/no_pic.jpg'},
