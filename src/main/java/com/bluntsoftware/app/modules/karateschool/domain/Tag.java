...
@Table(name = "\"Tag\"")
public class Tag implements CustomDomain<Tag> {
    ...
    @SequenceGenerator(name = "Tag_id_seq", allocationSize = 1, sequenceName = "Tag_id_seq", initialValue = 1)
    @Column(name = "\"id\"")
